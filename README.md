...
and uncompress it to `/usr/local`
    ...
    curl -Ls https://github.com/r-lib/rig/releases/download/v0.4.2/rig-linux-0.4.2.tar.gz |
      sudo tar xz -C /usr/local

If you are running Linux on arm64, download the arm64 build:

    curl -Ls https://github.com/r-lib/rig/releases/download/v0.4.2/rig-linux-arm64-0.4.2.tar.gz |
      sudo tar xz -C /usr/local

...
version control — `.Renviron`, a marked block in `.gitignore`,
`.rvenv/lib/.gitignore` and the `.rvenv/lib/rig` shim package. See
...
lockfile. The default is the lockfile's R version.

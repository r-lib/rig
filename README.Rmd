...
```
curl -Ls https://github.com/gaborcsardi/rim/releases/download/v0.2.4/rim-linux-0.2.4.tar.gz |
  sudo tar xz -C /usr/local
```

If you are running Linux on arm64, download the arm64 build:
```
curl -Ls https://github.com/gaborcsardi/rim/releases/download/v0.2.4/rim-linux-arm64-0.2.4.tar.gz |
  sudo tar xz -C /usr/local
```

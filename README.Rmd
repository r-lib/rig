...
```
curl -Ls https://github.com/r-lib/rig/releases/download/v0.3.1/rig-linux-0.3.1.tar.gz |
  sudo tar xz -C /usr/local
```

If you are running Linux on arm64, download the arm64 build:
```
curl -Ls https://github.com/r-lib/rig/releases/download/v0.3.1/rig-linux-arm64-0.3.1.tar.gz |
  sudo tar xz -C /usr/local
```
